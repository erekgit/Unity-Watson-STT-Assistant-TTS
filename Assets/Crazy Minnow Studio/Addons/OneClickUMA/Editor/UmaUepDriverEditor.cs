...
namespace CrazyMinnow.SALSA.OneClicks
{
	...
	public class UmaUepDriverEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			GUILayout.BeginHorizontal();
			GUILayout.FlexibleSpace();
			if (GUILayout.Button(new GUIContent("Using " + (uepDriver.previewModel == UmaUepDriver.PreviewModel.Male ? "Male" : "Female") + 
			                                    " Preview Model", "Click to switch models."), GUILayout.ExpandWidth(false)))
			{
